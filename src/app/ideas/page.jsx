import IdeasPageContent from "@/components/IdeasPageContent";
...
export const metadata = {
  ...
  description:
    "Explore innovative startup ideas, search by title, and filter ideas by category on IdeaVault.",
};

const IdeasPage = () => {
  return <IdeasPageContent></IdeasPageContent> ;
};
