  ...
  const {token}  = await auth.api.getToken({
    ...
    return (
        <div className="max-w-7xl mx-auto py-10 space-y-6">
            ...
            <div>
              {
                comments.length == 0 ? <div className="flex justify-center items-center py-20">
      <Card className="w-full max-w-md p-10 border border-dashed border-gray-300 dark:border-gray-700 rounded-2xl shadow-none text-center space-y-4">
        ...
        <p className="text-gray-500">
          You have not added any Comments yet. Start sharing your innovative startup ideas with the world.
        </p>
